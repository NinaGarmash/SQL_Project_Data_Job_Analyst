...
-- Do the same for jobs in Israel
*/
...
-- the saame query for jobs in Israel, but we set threshold for demand_count lower - "> 1"
...
For Israel:
There are only 8 resulting optimal skills which are both  high_paying(in top 25) and in high demand, 
