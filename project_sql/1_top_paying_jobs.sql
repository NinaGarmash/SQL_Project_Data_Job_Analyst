...
- Do the same for jobs available in Israel and compare the results
*/
...
In Israel salary range is a lot narrower:  $111,175 - 105,000, with 9 of the 10 companies having the same salary_year_avg. The fact that Data Analyst Student - part time 
position has the same salary as Senior Threat Intelligence Analyst should be an error. 
...
[
  ...
  {
    "job_id": 748679,
    "job_title": "Operations Optimization Specialist - Data Analyst",
    "job_location": "Tel Aviv-Yafo, Israel",
    "job_schedule_type": "Full-time",
    "salary_year_avg": "105000.0",
    "job_posted_date": "2023-08-01 21:22:19",
    "company_name": "Wolt"
  }
]
*/
